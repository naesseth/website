...
My research interests span approximate statistical inference, uncertainty quantification, causality and artificial intelligence, as well as their application to the sciences. I am currently working on generative models (diffusions, normalising flows, generative flow networks, ...), approximate Bayesian inference (variational and Monte Carlo methods), probabilistic modelling (Gaussian processes, chemistry applications, ...), uncertainty quantification and hypothesis testing (E-values, conformal prediction, ...).
